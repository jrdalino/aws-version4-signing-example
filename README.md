...
- Access key ID and Secret access key in environment variables
```
(venv) $ export AWS_ACCESS_KEY_ID=<REPLACE_ME>
(venv) $ export AWS_SECRET_ACCESS_KEY=<REPLACE_ME>
(venv) $ echo $AWS_ACCESS_KEY_ID
(venv) $ echo $AWS_SECRET_ACCESS_KEY
```

## Create app.py (from https://docs.aws.amazon.com/general/latest/gr/sigv4-signed-request-examples.html)
```
# AWS Version 4 signing example

# See: http://docs.aws.amazon.com/general/latest/gr/sigv4_signing.html
# This version makes a GET request EC2 API (DescribeRegions) and passes the signature in the Authorization header.
...
<DescribeRegionsResponse xmlns="http://ec2.amazonaws.com/doc/2013-10-15/">
    <requestId>2411221c-b5a7-41ed-bac0-e0d457a9d5fd</requestId>
    <regionInfo>
        <item>
